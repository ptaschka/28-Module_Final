...
def test_authorisation_with_empty_e_mail(web_browser):
    """ Test authorisation with empty email and valid password"""
    page = AuthPage(web_browser)
...
def test_authorisation_with_empty_passw(web_browser):
    """ Test authorisation with valid email and empty password"""
    page = AuthPage(web_browser)
    page.email.send_keys(e_mail)
    page.password.send_keys("")
    assert page.btn.is_clickable() == False

def test_authorisation_with_empty_e_mail_passw(web_browser):
    """ Test authorisation with empty email and empty password"""
    page = AuthPage(web_browser)
    page.email.send_keys("")
    page.password.send_keys("")
    assert page.btn.is_clickable() == False
